...
/**
 * model for a LoginAttempt. There was consideration for creating a DAO for this model, but I didn't want to murk up the requirements for the project by doing so, This model was intended to
