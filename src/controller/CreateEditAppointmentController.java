...
public class CreateEditAppointmentController {
     ...
     * @see model.Appointment#endsAfterStart
     * @see model.Appointment#startAndEndSame
     * @see model.Appointment#isWithinBusinessHours(Appointment)
     * @see model.Appointment#isConflictingWithCustomer
     */
